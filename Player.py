...
# class Player:
#     def __init__(self, x, y, left_key, right_key, jump_key, run_key, attack_key, dodge_key):
#         self.pos_x = x
#         self.pos_y = y
#         self.vitesse_y = 0
#         self.in_air = False
...
#                 self._start_attack("attack_1")
#             elif touches[pygame.K_z]:
#                 self._start_attack("attack_2")
#             elif touches[pygame.K_e]:
#                 self._start_attack("attack_3")
